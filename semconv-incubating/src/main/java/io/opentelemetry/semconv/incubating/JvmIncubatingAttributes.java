...
public final class JvmIncubatingAttributes {
  ...
  * <p>Notes:
        ...
        <ul> <li>Garbage collector action is generally obtained via <a href="https://docs.oracle.com/en/java/javase/11/docs/api/jdk.management/com/sun/management/GarbageCollectionNotificationInfo.html#getGcAction()">GarbageCollectionNotificationInfo#getGcAction()</a>.</li> </ul>
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.JvmAttributes#JVM_GC_ACTION} attribute.
  */
  @Deprecated
  ...
  * <p>Notes:
        ...
        <ul> <li>Garbage collector name is generally obtained via <a href="https://docs.oracle.com/en/java/javase/11/docs/api/jdk.management/com/sun/management/GarbageCollectionNotificationInfo.html#getGcName()">GarbageCollectionNotificationInfo#getGcName()</a>.</li> </ul>
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.JvmAttributes#JVM_GC_NAME} attribute.
  */
  @Deprecated
  ...
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.JvmAttributes#JVM_MEMORY_POOL_NAME} attribute.
  */
  @Deprecated
  ...
  * The type of memory.
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.JvmAttributes#JVM_MEMORY_TYPE} attribute.
  */
  @Deprecated
  ...
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.JvmAttributes#JVM_THREAD_DAEMON} attribute.
  */
  @Deprecated
  ...
  * State of the thread.
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.JvmAttributes#JVM_THREAD_STATE} attribute.
  */
  @Deprecated
  ...
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.JvmAttributes.JvmMemoryTypeValues} attribute.
  */
  @Deprecated
  ...
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.JvmAttributes.JvmThreadStateValues} attribute.
  */
  @Deprecated
