...
public final class AwsIncubatingAttributes {
  ...
  *
  */
  public static final AttributeKey<List<String>> AWS_DYNAMODB_ATTRIBUTEDEFINITIONS = stringArrayKey("aws.dynamodb.attribute_definitions");

  /**
  * The value of the {@code AttributesToGet} request parameter.
  *
  */
  public static final AttributeKey<List<String>> AWS_DYNAMODB_ATTRIBUTESTOGET = stringArrayKey("aws.dynamodb.attributes_to_get");

  /**
  * The value of the {@code ConsistentRead} request parameter.
  *
  */
  public static final AttributeKey<Boolean> AWS_DYNAMODB_CONSISTENTREAD = booleanKey("aws.dynamodb.consistent_read");

  /**
  * The JSON-serialized value of each item in the {@code ConsumedCapacity} response field.
  *
  */
  public static final AttributeKey<List<String>> AWS_DYNAMODB_CONSUMEDCAPACITY = stringArrayKey("aws.dynamodb.consumed_capacity");
  ...
  *
  */
  public static final AttributeKey<String> AWS_DYNAMODB_EXCLUSIVESTARTTABLE = stringKey("aws.dynamodb.exclusive_start_table");

  /**
  * The JSON-serialized value of each item in the {@code GlobalSecondaryIndexUpdates} request field.
  *
  */
  public static final AttributeKey<List<String>> AWS_DYNAMODB_GLOBALSECONDARYINDEXUPDATES = stringArrayKey("aws.dynamodb.global_secondary_index_updates");

  /**
  * The JSON-serialized value of each item of the {@code GlobalSecondaryIndexes} request field
  *
  */
  public static final AttributeKey<List<String>> AWS_DYNAMODB_GLOBALSECONDARYINDEXES = stringArrayKey("aws.dynamodb.global_secondary_indexes");

  /**
  * The value of the {@code IndexName} request parameter.
  *
  */
  public static final AttributeKey<String> AWS_DYNAMODB_INDEXNAME = stringKey("aws.dynamodb.index_name");

  /**
  * The JSON-serialized value of the {@code ItemCollectionMetrics} response field.
  *
  */
  public static final AttributeKey<String> AWS_DYNAMODB_ITEMCOLLECTIONMETRICS = stringKey("aws.dynamodb.item_collection_metrics");
  ...
  *
  */
  public static final AttributeKey<List<String>> AWS_DYNAMODB_LOCALSECONDARYINDEXES = stringArrayKey("aws.dynamodb.local_secondary_indexes");

  /**
  * The value of the {@code ProjectionExpression} request parameter.
  *
  */
  public static final AttributeKey<String> AWS_DYNAMODB_PROJECTION = stringKey("aws.dynamodb.projection");

  /**
  * The value of the {@code ProvisionedThroughput.ReadCapacityUnits} request parameter.
  *
  */
  public static final AttributeKey<Double> AWS_DYNAMODB_PROVISIONEDREADCAPACITY = doubleKey("aws.dynamodb.provisioned_read_capacity");

  /**
  * The value of the {@code ProvisionedThroughput.WriteCapacityUnits} request parameter.
  *
  */
  public static final AttributeKey<Double> AWS_DYNAMODB_PROVISIONEDWRITECAPACITY = doubleKey("aws.dynamodb.provisioned_write_capacity");

  /**
  * The value of the {@code ScanIndexForward} request parameter.
  *
  */
  public static final AttributeKey<Boolean> AWS_DYNAMODB_SCANFORWARD = booleanKey("aws.dynamodb.scan_forward");

  /**
  * The value of the {@code ScannedCount} response parameter.
  *
  */
  public static final AttributeKey<Long> AWS_DYNAMODB_SCANNEDCOUNT = longKey("aws.dynamodb.scanned_count");
  ...
  *
  */
  public static final AttributeKey<Long> AWS_DYNAMODB_TABLECOUNT = longKey("aws.dynamodb.table_count");

  /**
  * The keys in the {@code RequestItems} object field.
  *
  */
  public static final AttributeKey<List<String>> AWS_DYNAMODB_TABLENAMES = stringArrayKey("aws.dynamodb.table_names");

  /**
  * The value of the {@code TotalSegments} request parameter.
  *
  */
  public static final AttributeKey<Long> AWS_DYNAMODB_TOTALSEGMENTS = longKey("aws.dynamodb.total_segments");
  ...
  *
  */
  public static final AttributeKey<String> AWS_ECS_CONTAINER_ARN = stringKey("aws.ecs.container.arn");
  ...
  *
  */
  public static final AttributeKey<String> AWS_ECS_TASK_REVISION = stringKey("aws.ecs.task.revision");
  ...
  */
  ...
  /**
  * The full invoked ARN as provided on the {@code Context} passed to the function ({@code Lambda-Runtime-Invoked-Function-Arn} header on the {@code /runtime/invocation/next} applicable).
  *
  * <p>Notes:
  ...
  *
  */
  public static final AttributeKey<String> AWS_LAMBDA_INVOKEDARN = stringKey("aws.lambda.invoked_arn");
  ...
  *
  */
  public static final AttributeKey<List<String>> AWS_LOG_GROUP_ARNS = stringArrayKey("aws.log.group.arns");
  ...
  *
  */
  public static final AttributeKey<List<String>> AWS_LOG_GROUP_NAMES = stringArrayKey("aws.log.group.names");
  ...
  *
  */
  public static final AttributeKey<List<String>> AWS_LOG_STREAM_ARNS = stringArrayKey("aws.log.stream.arns");

  /**
  * The name(s) of the AWS log stream(s) an application is writing to.
  *
  */
  public static final AttributeKey<List<String>> AWS_LOG_STREAM_NAMES = stringArrayKey("aws.log.stream.names");

  /**
  * The AWS request ID as returned in the response headers {@code x-amz-request-id} or {@code x-amz-requestid}.
  *
  */
  public static final AttributeKey<String> AWS_REQUESTID = stringKey("aws.request_id");

  /**
  * The S3 bucket name the request refers to. Corresponds to the {@code --bucket} parameter of the <a href="https://docs.aws.amazon.com/cli/latest/reference/s3api/index.html">S3 API</a> operations.
  *
  * <p>Notes:
        
        
        <ul> <li>The {@code bucket} attribute is applicable to all S3 operations that reference a bucket, i.e. that require the bucket name as a mandatory parameter.
This applies to almost all S3 operations except {@code list-buckets}.</li> </ul>
  *
  */
  ...
  * <p>Notes:
        ...
        <ul> <li>The {@code copy_source} attribute applies to S3 copy operations and corresponds to the {@code --copy-source} parameter
...
<li><a href="https://docs.aws.amazon.com/cli/latest/reference/s3api/upload-part-copy.html">upload-part-copy</a></li>
  ...
  * <p>Notes:
        ...
        <ul> <li>The {@code delete} attribute is only applicable to the <a href="https://docs.aws.amazon.com/cli/latest/reference/s3api/delete-object.html">delete-object</a> operation.
The {@code delete} attribute corresponds to the {@code --delete} parameter of the
<a href="https://docs.aws.amazon.com/cli/latest/reference/s3api/delete-objects.html">delete-objects operation within the S3 API</a>.</li> </ul>
  ...
  */
  ...
  /**
  * The S3 object key the request refers to. Corresponds to the {@code --key} parameter of the <a href="https://docs.aws.amazon.com/cli/latest/reference/s3api/index.html">S3 API</a> operations.
  *
  * <p>Notes:
        
        
        <ul> <li>The {@code key} attribute is applicable to all object-related S3 operations, i.e. that require the object key as a mandatory parameter.
This applies in particular to the following operations:</li><li><a href="https://docs.aws.amazon.com/cli/latest/reference/s3api/copy-object.html">copy-object</a></li>
...
<li><a href="https://docs.aws.amazon.com/cli/latest/reference/s3api/upload-part-copy.html">upload-part-copy</a></li>
  ...
  * <p>Notes:
        ...
        <ul> <li>The {@code part_number} attribute is only applicable to the <a href="https://docs.aws.amazon.com/cli/latest/reference/s3api/upload-part.html">upload-part</a>
and <a href="https://docs.aws.amazon.com/cli/latest/reference/s3api/upload-part-copy.html">upload-part-copy</a> operations.
The {@code part_number} attribute corresponds to the {@code --part-number} parameter of the
<a href="https://docs.aws.amazon.com/cli/latest/reference/s3api/upload-part.html">upload-part operation within the S3 API</a>.</li> </ul>
  ...
  * <p>Notes:
        ...
        <ul> <li>The {@code upload_id} attribute applies to S3 multipart-upload operations and corresponds to the {@code --upload-id} parameter
