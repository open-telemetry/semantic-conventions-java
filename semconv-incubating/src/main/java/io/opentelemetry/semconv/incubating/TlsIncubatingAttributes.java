...
public final class TlsIncubatingAttributes {
  ...
  * <p>Notes:
        ...
        <ul> <li>The values allowed for {@code tls.cipher} MUST be one of the {@code Descriptions} of the <a href="https://www.iana.org/assignments/tls-parameters/tls-parameters.xhtml#table-tls-parameters-4">registered TLS Cipher Suits</a>.</li> </ul>
  *
  */
  public static final AttributeKey<String> TLS_CIPHER = stringKey("tls.cipher");

  /**
  * PEM-encoded stand-alone certificate offered by the client. This is usually mutually-exclusive of {@code client.certificate_chain} since this value also exists in that list.
  *
  */
  public static final AttributeKey<String> TLS_CLIENT_CERTIFICATE = stringKey("tls.client.certificate");

  /**
  * Array of PEM-encoded certificates that make up the certificate chain offered by the client. This is usually mutually-exclusive of {@code client.certificate} since that value should be the first certificate in the chain.
  *
  */
  public static final AttributeKey<List<String>> TLS_CLIENT_CERTIFICATECHAIN = stringArrayKey("tls.client.certificate_chain");
  ...
  *
  */
  public static final AttributeKey<String> TLS_CLIENT_HASH_SHA256 = stringKey("tls.client.hash.sha256");
  ...
  *
  */
  public static final AttributeKey<String> TLS_CLIENT_NOTBEFORE = stringKey("tls.client.not_before");

  /**
  * Also called an SNI, this tells the server which hostname to which the client is attempting to connect to.
  *
  */
  public static final AttributeKey<String> TLS_CLIENT_SERVERNAME = stringKey("tls.client.server_name");
  ...
  *
  */
  public static final AttributeKey<List<String>> TLS_CLIENT_SUPPORTEDCIPHERS = stringArrayKey("tls.client.supported_ciphers");
  ...
  */
  ...
  /**
  * PEM-encoded stand-alone certificate offered by the server. This is usually mutually-exclusive of {@code server.certificate_chain} since this value also exists in that list.
  *
  */
  public static final AttributeKey<String> TLS_SERVER_CERTIFICATE = stringKey("tls.server.certificate");

  /**
  * Array of PEM-encoded certificates that make up the certificate chain offered by the server. This is usually mutually-exclusive of {@code server.certificate} since that value should be the first certificate in the chain.
  *
  */
  public static final AttributeKey<List<String>> TLS_SERVER_CERTIFICATECHAIN = stringArrayKey("tls.server.certificate_chain");
  ...
  *
  */
  public static final AttributeKey<String> TLS_SERVER_HASH_SHA256 = stringKey("tls.server.hash.sha256");
  ...
  *
  */
  public static final AttributeKey<String> TLS_SERVER_NOTBEFORE = stringKey("tls.server.not_before");
