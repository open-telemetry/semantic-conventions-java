...
public final class CloudeventsIncubatingAttributes {
  ...
  *
  */
  public static final AttributeKey<String> CLOUDEVENTS_EVENTSOURCE = stringKey("cloudevents.event_source");
  ...
  *
  */
  public static final AttributeKey<String> CLOUDEVENTS_EVENTSPECVERSION = stringKey("cloudevents.event_spec_version");
  ...
  *
  */
  public static final AttributeKey<String> CLOUDEVENTS_EVENTSUBJECT = stringKey("cloudevents.event_subject");
  ...
  *
  */
  public static final AttributeKey<String> CLOUDEVENTS_EVENTTYPE = stringKey("cloudevents.event_type");
