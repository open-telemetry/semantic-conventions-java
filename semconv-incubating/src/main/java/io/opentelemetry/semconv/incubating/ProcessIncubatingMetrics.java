...
public final class ProcessIncubatingMetrics {
  ...
  /** Name of the {@code process.unix.file_descriptor.count} metric. */
  public static final String PROCESS_UNIX_FILE_DESCRIPTOR_COUNT_NAME =
      "process.unix.file_descriptor.count";

  /** Unit of the {@code process.unix.file_descriptor.count} metric. */
  public static final String PROCESS_UNIX_FILE_DESCRIPTOR_COUNT_UNIT = "{file_descriptor}";
  ...
  /** Name of the {@code process.windows.handle.count} metric. */
  public static final String PROCESS_WINDOWS_HANDLE_COUNT_NAME = "process.windows.handle.count";

  /** Unit of the {@code process.windows.handle.count} metric. */
  public static final String PROCESS_WINDOWS_HANDLE_COUNT_UNIT = "{handle}";

  /** Description of the {@code process.windows.handle.count} metric. */
  public static final String PROCESS_WINDOWS_HANDLE_COUNT_DESCRIPTION =
