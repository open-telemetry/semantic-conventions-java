...
public final class DnsIncubatingMetrics {
  ...
  /** Unit of the {@code dns.lookup.duration} metric. */
  public static final String DNS_LOOKUP_DURATION_UNIT = "s";

  /** Description of the {@code dns.lookup.duration} metric. */
  public static final String DNS_LOOKUP_DURATION_DESCRIPTION =
      "Measures the time taken to perform a DNS lookup.";

  private DnsIncubatingMetrics() {}
}
