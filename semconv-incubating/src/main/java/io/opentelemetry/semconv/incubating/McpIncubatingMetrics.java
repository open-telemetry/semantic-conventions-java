...
public final class McpIncubatingMetrics {
   ...
   *     semantic conventions repository</a>.
   */
  @Deprecated public static final String MCP_CLIENT_OPERATION_DURATION_UNIT = "s";
   ...
   *     semantic conventions repository</a>.
   */
  @Deprecated public static final String MCP_CLIENT_SESSION_DURATION_UNIT = "s";
   ...
   *     semantic conventions repository</a>.
   */
  @Deprecated public static final String MCP_SERVER_OPERATION_DURATION_UNIT = "s";
   ...
   *     semantic conventions repository</a>.
   */
  @Deprecated public static final String MCP_SERVER_SESSION_DURATION_UNIT = "s";
