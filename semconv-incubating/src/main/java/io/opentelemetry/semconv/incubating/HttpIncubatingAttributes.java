...
public final class HttpIncubatingAttributes {
  ...
  * <p>Notes:
        ...
        <ul> <li>Instrumentations SHOULD require an explicit configuration of which headers are to be captured. Including all request headers can be a security risk - explicit configuration helps avoid leaking sensitive information.
...
The attribute value MUST consist of either multiple header values as an array of strings or a single-item array containing a possibly comma-concatenated string, depending on the way the HTTP library provides access to headers.</li> </ul>
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.HttpAttributes#HTTP_REQUEST_HEADER} attribute.
  */
  @Deprecated
...
and the PATCH method defined in <a href="https://www.rfc-editor.org/rfc/rfc5789.html">RFC5789</a>.</li><li>If the HTTP request method is not known to instrumentation, it MUST set the {@code http.request.method} attribute to {@code _OTHER}.</li><li>If the HTTP instrumentation could end up converting valid HTTP request methods to {@code _OTHER}, then it MUST provide a way to override
the list of known HTTP methods. If this override is done via environment variable, then the environment variable MUST be named
OTEL_INSTRUMENTATION_HTTP_KNOWN_METHODS and support a comma-separated list of case-sensitive known HTTP methods
(this list MUST be a full override of the default known method, it is not a list of known methods in addition to the defaults).</li><li>HTTP method names are case-sensitive and {@code http.request.method} attribute value MUST match a known HTTP method name exactly.
Instrumentations for specific web frameworks that consider HTTP methods to be case insensitive, SHOULD populate a canonical equivalent.
Tracing instrumentations that do so, MUST also set {@code http.request.method_original} to the original value.</li> </ul>
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.HttpAttributes#HTTP_REQUEST_METHOD} attribute.
  */
  @Deprecated
  ...
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.HttpAttributes#HTTP_REQUEST_METHODORIGINAL} attribute.
  */
  @Deprecated
  public static final AttributeKey<String> HTTP_REQUEST_METHODORIGINAL = stringKey("http.request.method_original");
  ...
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.HttpAttributes#HTTP_REQUEST_RESENDCOUNT} attribute.
  */
  @Deprecated
  public static final AttributeKey<Long> HTTP_REQUEST_RESENDCOUNT = longKey("http.request.resend_count");
  ...
  */
  @Deprecated
  public static final AttributeKey<Long> HTTP_REQUESTCONTENTLENGTH = longKey("http.request_content_length");
  ...
  * <p>Notes:
        ...
        <ul> <li>Instrumentations SHOULD require an explicit configuration of which headers are to be captured. Including all response headers can be a security risk - explicit configuration helps avoid leaking sensitive information.
Users MAY explicitly configure instrumentations to capture them even though it is not recommended.
The attribute value MUST consist of either multiple header values as an array of strings or a single-item array containing a possibly comma-concatenated string, depending on the way the HTTP library provides access to headers.</li> </ul>
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.HttpAttributes#HTTP_RESPONSE_HEADER} attribute.
  */
  @Deprecated
  public static final AttributeKeyTemplate<List<String>> HTTP_RESPONSE_HEADER = stringArrayKeyTemplate("http.response.header");
  ...
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.HttpAttributes#HTTP_RESPONSE_STATUSCODE} attribute.
  */
  @Deprecated
  public static final AttributeKey<Long> HTTP_RESPONSE_STATUSCODE = longKey("http.response.status_code");
  ...
  */
  @Deprecated
  public static final AttributeKey<Long> HTTP_RESPONSECONTENTLENGTH = longKey("http.response_content_length");
...
SHOULD include the <a href="/docs/http/http-spans.md#http-server-definitions">application root</a> if there is one.</li> </ul>
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.HttpAttributes#HTTP_ROUTE} attribute.
  */
  @Deprecated
  ...
  */
  @Deprecated
  public static final AttributeKey<Long> HTTP_STATUSCODE = longKey("http.status_code");
  ...
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.HttpAttributes.HttpRequestMethodValues} attribute.
  */
  @Deprecated
