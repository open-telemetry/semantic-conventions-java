...
public final class UserAgentIncubatingAttributes {
   ...
   *       microservices with multiple names/versions inside the <code>user_agent.original</code>,
   *       the most significant name SHOULD be selected. In such a scenario it should align with
   *       <code>user_agent.version</code>
   * </ul>
   */
   ...
   *       original string. In the case of using a user-agent for non-browser products, such as
   *       microservices with multiple names/versions inside the <code>user_agent.original</code>,
   *       the most significant version SHOULD be selected. In such a scenario it should align with
   *       <code>user_agent.name</code>
   * </ul>
   */
