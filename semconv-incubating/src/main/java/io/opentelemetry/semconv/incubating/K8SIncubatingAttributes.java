...
public final class K8SIncubatingAttributes {
   ...
   * </ul>
   */
  public static final AttributeKey<String> K_8_S_CLUSTER_UID = stringKey("k8s.cluster.uid");
   ...
   */
  public static final AttributeKey<Long> K_8_S_CONTAINER_RESTART_COUNT =
      longKey("k8s.container.restart_count");

  /** The name of the CronJob. */
  public static final AttributeKey<String> K_8_S_CRONJOB_NAME = stringKey("k8s.cronjob.name");

  /** The UID of the CronJob. */
  public static final AttributeKey<String> K_8_S_CRONJOB_UID = stringKey("k8s.cronjob.uid");

  /** The name of the DaemonSet. */
  public static final AttributeKey<String> K_8_S_DAEMONSET_NAME = stringKey("k8s.daemonset.name");

  /** The UID of the DaemonSet. */
  public static final AttributeKey<String> K_8_S_DAEMONSET_UID = stringKey("k8s.daemonset.uid");

  /** The name of the Deployment. */
  public static final AttributeKey<String> K_8_S_DEPLOYMENT_NAME = stringKey("k8s.deployment.name");

  /** The UID of the Deployment. */
  public static final AttributeKey<String> K_8_S_DEPLOYMENT_UID = stringKey("k8s.deployment.uid");

  /** The name of the Job. */
  public static final AttributeKey<String> K_8_S_JOB_NAME = stringKey("k8s.job.name");

  /** The UID of the Job. */
  public static final AttributeKey<String> K_8_S_JOB_UID = stringKey("k8s.job.uid");

  /** The name of the namespace that the pod is running in. */
  public static final AttributeKey<String> K_8_S_NAMESPACE_NAME = stringKey("k8s.namespace.name");

  /** The name of the Node. */
  public static final AttributeKey<String> K_8_S_NODE_NAME = stringKey("k8s.node.name");
  ...
  /** The name of the Pod. */
  public static final AttributeKey<String> K_8_S_POD_NAME = stringKey("k8s.pod.name");

  /** The UID of the Pod. */
  public static final AttributeKey<String> K_8_S_POD_UID = stringKey("k8s.pod.uid");

  /** The name of the ReplicaSet. */
  public static final AttributeKey<String> K_8_S_REPLICASET_NAME = stringKey("k8s.replicaset.name");

  /** The UID of the ReplicaSet. */
  public static final AttributeKey<String> K_8_S_REPLICASET_UID = stringKey("k8s.replicaset.uid");

  /** The name of the StatefulSet. */
  public static final AttributeKey<String> K_8_S_STATEFULSET_NAME =
      stringKey("k8s.statefulset.name");
