...
public final class TelemetryIncubatingAttributes {
   ...
   *     io.opentelemetry.semconv.TelemetryAttributes#TELEMETRY_DISTRO_NAME} attribute.
   */
  @Deprecated
   ...
   *
   * @deprecated deprecated in favor of stable {@link
   *     io.opentelemetry.semconv.TelemetryAttributes#TELEMETRY_DISTRO_VERSION} attribute.
   */
  @Deprecated
