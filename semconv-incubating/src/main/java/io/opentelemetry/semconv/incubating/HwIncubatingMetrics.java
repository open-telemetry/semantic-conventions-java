...
public final class HwIncubatingMetrics {
  ...
  /** Description of the {@code hw.errors} metric. */
  public static final String HW_ERRORS_DESCRIPTION = "Number of errors encountered by the GPU.";
  ...
  /** Description of the {@code hw.errors} metric. */
  public static final String HW_ERRORS_DESCRIPTION = "Number of errors encountered on this disk.";
