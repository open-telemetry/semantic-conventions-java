...
public final class DbIncubatingAttributes {
   ...
   *       not recommended to attempt any client-side parsing of `db.statement` just to get this
   *       property, but it should be set if it is provided by the library being instrumented. If
   *       the operation is acting upon an anonymous table, or more than one table, this value MUST
   *       NOT be set.
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>If setting a `db.mssql.instance_name`, `server.port` is no longer required (but still
   ...
   *
   * <ul>
   *   <li>In some SQL databases, the database name to be used is called "schema name". In case
   ...
   *
   * <ul>
   *   <li>It is not recommended to attempt any client-side parsing of `db.statement` just to get
  ...
  public static final class DbSystemValues {
    ...
    /** Neo4j */
    public static final String NEO_4_J = "neo4j";
