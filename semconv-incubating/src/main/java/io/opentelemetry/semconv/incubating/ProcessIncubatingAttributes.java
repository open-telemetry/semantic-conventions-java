...
public final class ProcessIncubatingAttributes {
   ...
   */
  public static final AttributeKey<List<String>> PROCESS_COMMANDARGS =
  ...
  public static final AttributeKey<String> PROCESS_CONTEXTSWITCHTYPE =
   ...
   */
  public static final AttributeKey<String> PROCESS_PAGING_FAULTTYPE =
