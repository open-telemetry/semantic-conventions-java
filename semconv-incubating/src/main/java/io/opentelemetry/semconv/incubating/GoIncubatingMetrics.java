...
public final class GoIncubatingMetrics {
  ...
  /** Name of the {@code go.cpu.time} metric. */
  public static final String GO_CPU_TIME_NAME = "go.cpu.time";

  /** Unit of the {@code go.cpu.time} metric. */
  public static final String GO_CPU_TIME_UNIT = "s";

  /** Description of the {@code go.cpu.time} metric. */
  public static final String GO_CPU_TIME_DESCRIPTION =
  ...
  /** Name of the {@code go.memory.gc.cycles} metric. */
  public static final String GO_MEMORY_GC_CYCLES_NAME = "go.memory.gc.cycles";

  /** Unit of the {@code go.memory.gc.cycles} metric. */
  public static final String GO_MEMORY_GC_CYCLES_UNIT = "{gc_cycle}";

  /** Description of the {@code go.memory.gc.cycles} metric. */
  public static final String GO_MEMORY_GC_CYCLES_DESCRIPTION = "Number of completed GC cycles.";
  ...
  /** Name of the {@code go.memory.gc.pause.duration} metric. */
  public static final String GO_MEMORY_GC_PAUSE_DURATION_NAME = "go.memory.gc.pause.duration";

  /** Unit of the {@code go.memory.gc.pause.duration} metric. */
  public static final String GO_MEMORY_GC_PAUSE_DURATION_UNIT = "s";

  /** Description of the {@code go.memory.gc.pause.duration} metric. */
  public static final String GO_MEMORY_GC_PAUSE_DURATION_DESCRIPTION =
