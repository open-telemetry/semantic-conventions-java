...
public final class CodeIncubatingAttributes {
  ...
  /**
  * The column number in {@code code.filepath} best representing the operation. It SHOULD point within the code unit named in {@code code.function}.
  *
  */
  ...
  */
  ...
  /**
  * The line number in {@code code.filepath} best representing the operation. It SHOULD point within the code unit named in {@code code.function}.
  *
  */
  public static final AttributeKey<Long> CODE_LINENO = longKey("code.lineno");

  /**
  * The &quot;namespace&quot; within which {@code code.function} is defined. Usually the qualified class or module name, such that {@code code.namespace} + some separator + {@code code.function} form a unique identifier for the code unit.
  *
  */
