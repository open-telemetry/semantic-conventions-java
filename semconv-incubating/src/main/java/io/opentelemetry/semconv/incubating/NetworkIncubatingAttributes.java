...
public final class NetworkIncubatingAttributes {
  ...
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.NetworkAttributes#NETWORK_LOCAL_ADDRESS} attribute.
  */
  @Deprecated
  ...
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.NetworkAttributes#NETWORK_LOCAL_PORT} attribute.
  */
  @Deprecated
  ...
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.NetworkAttributes#NETWORK_PEER_ADDRESS} attribute.
  */
  @Deprecated
  ...
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.NetworkAttributes#NETWORK_PEER_PORT} attribute.
  */
  @Deprecated
  ...
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.NetworkAttributes#NETWORK_PROTOCOL_NAME} attribute.
  */
  @Deprecated
  ...
  * <p>Notes:
        ...
        <ul> <li>If protocol version is subject to negotiation (for example using <a href="https://www.rfc-editor.org/rfc/rfc7301.html">ALPN</a>), this attribute SHOULD be set to the negotiated version. If the actual protocol version is not known, this attribute SHOULD NOT be set.</li> </ul>
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.NetworkAttributes#NETWORK_PROTOCOL_VERSION} attribute.
  */
  @Deprecated
...
different processes could be listening on TCP port 12345 and UDP port 12345.</li> </ul>
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.NetworkAttributes#NETWORK_TRANSPORT} attribute.
  */
  @Deprecated
  ...
  * <p>Notes:
        ...
        <ul> <li>The value SHOULD be normalized to lowercase.</li> </ul>
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.NetworkAttributes#NETWORK_TYPE} attribute.
  */
  @Deprecated
  ...
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.NetworkAttributes.NetworkTransportValues} attribute.
  */
  @Deprecated
  ...
  *
  * @deprecated deprecated in favor of stable {@link io.opentelemetry.semconv.NetworkAttributes.NetworkTypeValues} attribute.
  */
  @Deprecated
