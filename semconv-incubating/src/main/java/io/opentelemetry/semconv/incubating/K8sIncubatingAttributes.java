...
Which states:</li><li>If generated according to one of the mechanisms defined in Rec.
...
conflict.</li> </ul>
  ...
  */
  ...
  /**
  * The name of the Container from Pod specification, must be unique within a Pod. Container runtime usually uses different globally unique name ({@code container.name}).
  *
  */
  ...
  *
  */
  public static final AttributeKey<Long> K8S_CONTAINER_RESTARTCOUNT = longKey("k8s.container.restart_count");
  ...
  */
  ...
  /**
  * The annotation key-value pairs placed on the Pod, the {@code <key>} being the annotation name, the value being the annotation value.
  *
  */
  public static final AttributeKeyTemplate<String> K8S_POD_ANNOTATION = stringKeyTemplate("k8s.pod.annotation");

  /**
  * The label key-value pairs placed on the Pod, the {@code <key>} being the label name, the value being the label value.
  *
  */
  public static final AttributeKeyTemplate<String> K8S_POD_LABEL = stringKeyTemplate("k8s.pod.label");
  ...
  */
  @Deprecated
  public static final AttributeKeyTemplate<String> K8S_POD_LABELS = stringKeyTemplate("k8s.pod.labels");
