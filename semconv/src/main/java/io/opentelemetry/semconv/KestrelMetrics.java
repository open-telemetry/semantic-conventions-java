...
public final class KestrelMetrics {
  ...
  public static final String KESTREL_ACTIVE_CONNECTIONS_UNIT = "{connection}";
  ...
  public static final String KESTREL_ACTIVE_TLS_HANDSHAKES_UNIT = "{handshake}";
  ...
  public static final String KESTREL_CONNECTION_DURATION_UNIT = "s";
  ...
  public static final String KESTREL_QUEUED_CONNECTIONS_UNIT = "{connection}";
  ...
  public static final String KESTREL_QUEUED_REQUESTS_NAME = "kestrel.queued_requests";

  /** Unit of the {@code kestrel.queued_requests} metric. */
  public static final String KESTREL_QUEUED_REQUESTS_UNIT = "{request}";
  ...
  public static final String KESTREL_REJECTED_CONNECTIONS_UNIT = "{connection}";
  ...
  public static final String KESTREL_TLS_HANDSHAKE_DURATION_UNIT = "s";
  ...
  public static final String KESTREL_UPGRADED_CONNECTIONS_UNIT = "{connection}";
